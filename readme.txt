...
This plugin provides one function - brutally removing all traces of the ugly
[retina.js](http://imulus.github.io/retinajs) script via dequeue + deregister.

Also thanks Tim Ash for suggesting stripping retina.min.js too.
...
= 1.5 =
* 2017-02-03
* Bump readme.txt "Stable Tag" + plugin.php "Version" to match + show up correctly on [http://WordPress.org](http://WordPress.org) download page
* Add stripping of retina.js.min for minified versions of this script.
